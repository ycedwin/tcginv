...
| Parallel | blank = normal. `y` / `parallel` / `alt` = ★ alt art. `sp` = SP art. `jolly roger` = JR foil from [CardRush](https://www.cardrush-op.jp/product/) |
...
Images: official Pokémon Card → [PriceCharting JP](https://www.pricecharting.com/category/pokemon-cards). Override with `thumbs/pkm/SV3-066.jpg`.
